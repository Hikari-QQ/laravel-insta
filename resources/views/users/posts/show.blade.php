                ...
                <div class="card-header bg-white py-3">
                    <div class="row align-itens-center">
                        ...
                        <div class="col-auto">
                            ...
                            {{-- Owner if the post can edit and delete --}}
                            ...
                            @else
                                {{-- If not owner of the post, show Unfollow button --}}
                                ...
                                @else
                                    <form action="{{ route('follow.store', $post->user->id) }}" method="post">
                                        @csrf
                                        <button type="submit" class="border-0 bg-transparent p-0 text-secondary">Follow</button>
                                    </form>
                                @endif
                            @endif
                        </div>
