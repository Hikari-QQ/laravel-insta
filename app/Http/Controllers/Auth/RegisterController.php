...
class RegisterController extends Controller
{
    ...
    */
    ...
    {
        //This line saves a user to database
        $user = User::create([
            'name' => $data['name'],
            'email' => $data['email'],
        ...
        Mail::send('users.emails.welcome', $details, function($message) use ($user) {
            //$message is an object representing the email being sent
            //$user - the person you want to send it to (user that is registering)
